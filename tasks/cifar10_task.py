...
def load_cifar_data_subsets(args, train_dataset):
    if args["iid"]:
        ...
        data_subsets = [get_train_data_subset_no_iid(args, indices, train_dataset) for indices in indices_per_participant.items()]
